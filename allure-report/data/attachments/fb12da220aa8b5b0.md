...
Call log:
  - waiting for locator('#coclors')

    at C:\Users\sabbavarapu.kumar\PlaywrightExample\tests\DropDown\multiselect.spec.js:4:14
```
...
- table:
  - rowgroup:
    - row "Name Memory (MB) Disk (MB/s) CPU (%) Network (Mbps)":
      ...
      - cell "Network (Mbps)"
  - rowgroup:
    - row "Firefox 55.9 MB 0.51 MB/s 8.5% 8.4 Mbps":
      - cell "Firefox"
      - cell "55.9 MB"
      - cell "0.51 MB/s"
      - cell "8.5%"
      - cell "8.4 Mbps"
    - row "Internet Explorer 32.5 MB 0.10 MB/s 6.2% 1.6 Mbps":
      - cell "Internet Explorer"
      - cell "32.5 MB"
      - cell "0.10 MB/s"
      - cell "6.2%"
      - cell "1.6 Mbps"
    - row "Chrome 53.2 MB 0.91 MB/s 5.1% 1.4 Mbps":
      - cell "Chrome"
      - cell "53.2 MB"
      - cell "0.91 MB/s"
      - cell "5.1%"
      - cell "1.4 Mbps"
    - row "System 82.8 MB 0.91 MB/s 5.2% 1.0 Mbps":
      - cell "System"
      - cell "82.8 MB"
      - cell "0.91 MB/s"
      - cell "5.2%"
