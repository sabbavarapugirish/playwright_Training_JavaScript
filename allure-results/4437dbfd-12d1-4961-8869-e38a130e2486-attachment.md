...
- Name: List Drop Down
- Location: C:\Users\sabbavarapu.kumar\PlaywrightExample\tests\DropDown\drop.spec.js:2:5
...
Call log:
  - navigating to "https://testautomationpractice.blogspot.com/#", waiting until "load"
    ...
    at C:\Users\sabbavarapu.kumar\PlaywrightExample\tests\DropDown\drop.spec.js:3:16
```
...
```ts
   ...
   2 | test('List Drop Down',async({page})=>{
>  3 |     await page.goto("https://testautomationpractice.blogspot.com/#");
     |                ^ Error: page.goto: Test timeout of 30000ms exceeded.
   4 |     await page.selectOption("#country",'India')
   5 |     await page.selectOption("#country",{label:"India"})
   6 |     await page.selectOption("#country",{value:'uk'})
   7 |     await page.selectOption("#country",{index:6})
   8 |     const options=await page.$$("//select[@id='country']/option")
   9 |     await expect(options.length).toBe(10);
  10 |     const option1=page.locator("//select[@id='country']/option")
  11 |     await expect(option1).toHaveCount(10);
  12 |     let f=false;
  13 |     for(const option of options)
  14 |         {
  15 |             const textOptions=await option.textContent();
  16 |             console.log(textOptions)
  17 |             if(textOptions.includes('India')){
  18 |                 f=true;
  19 |                 break;
  20 |             }
  21 |         }expect(f).toBeTruthy()
